        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul id="navlist" class="navbar-nav mr-auto">
                ...
                <li id="user" class="nav-item">
                    <a class="nav-link" href="vistas/usuario.php">Usuarios <span class="sr-only">(current)</span> </a>
                </li>
                <li id="caracteristica" class="nav-item">
                    <a class="nav-link" href="vistas/caracteristicas.php">Caracteristicas</a>
                </li>
                <li id="pelicula" class="nav-item">
                    <a class="nav-link" href="vistas/peliculas.php">Peliculas</a>
                </li>
                <li id="genero" class="nav-item">
                    <a class="nav-link" href="vistas/genero.php">Genero</a>
                </li>
